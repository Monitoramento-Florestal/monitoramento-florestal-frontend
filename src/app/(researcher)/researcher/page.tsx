...
const QUICK_ACTIONS = [
  ...
  { key: "profile", label: "Perfil", href: "/researcher/profile", icon: Trees },
];

export default function ResearcherDashboardHome() {
  return (
    <DashboardRoleLayout
      defaultUserName="Ana Beatriz Lima"
      headerTitle="Painel do pesquisador"
      headerSubtitle="11 registros sob sua responsabilidade"
