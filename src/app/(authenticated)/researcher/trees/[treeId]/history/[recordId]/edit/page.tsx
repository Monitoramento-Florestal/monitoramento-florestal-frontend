...
export default async function ResearcherEditRecordPage({
  params,
}: {
  ...
  return (
    <>
      <DashboardPageHeader
        ...
        subtitle={getTreeRecordFormSubtitle(UserRole.RESEARCHER, "edit-record")}
      />
      <div className="p-6">
        <TreeRecordFormScreen mode="edit-record" role={UserRole.RESEARCHER} tree={tree} record={record} />
      </div>
    </>
  );
}
